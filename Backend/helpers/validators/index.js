...
const validateCategory = (category) =>
  validator.validate(category, schemas.categorySchema);
const validateProduct = (product) =>
  validator.validate(product, schemas.productSchema);
const validateProductImage = (productImage) =>
  validator.validate(productImage, schemas.productImageSchema);
const validateProductDetail = (productDetail) =>
  validator.validate(productDetail, schemas.productDetailSchema);
...
const validateBillDetail = (billDetail) =>
  validator.validate(billDetail, schemas.billDetailSchema);
