    ...
    <div className="footer-container">
      <div className="footer-list">
        <div className="footer-service">
          <h3 className="footer-service-header">CHĂM SÓC KHÁCH HÀNG</h3>
        ...
        <div className="footer-shopee">
          <h3 className="footer-shopee-header">VỀ SHOPEE</h3>
        ...
        <div className="footer-payment">
          <h3 className="footer-payment-card">THANH TOÁN</h3>
          ...
          <h3 className="footer-delivery-card">ĐƠN VỊ VẬN CHUYỂN</h3>
        ...
        <div className="footer-follow">
          <h3 className="footer-follow-header">THEO DÕI CHÚNG TÔI TRÊN</h3>
        ...
        <div className="footer-download">
          <h3 className="footer-download-header">THANH TOÁN</h3>
          <div className="footer-download-img">
            ...
            <div className="footer-download-side">
              <img
                src={appstore}
                alt="anh"
                className="footer-download-pic-up"
              />
      ...
      <div className="footer-list_item">
        <div className="footer-list-link">
          <a href="/">CHÍNH SÁCH BẢO MẬT</a>{" "}
          <span className="footer-bottom-line footer-line"></span>
        </div>
        <div className="footer-list-link">
