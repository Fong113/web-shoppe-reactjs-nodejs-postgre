        ...
        {products.slice(5, 11).map((post) => {
          return (
            <Col
              key={post.id}
              span={4}
              className="home-page-main-content_flash-sale_product"
            >
              <Link to={"/flash-sale"}>
                <Item
                ...
                <div className="flash-sale_product_info">
                  <div className="flash-sale_product_info_price">
                    <p>
                      {"$" +
                        post.price
                          .toString()
                  ...
                  <div className="flash-sale_product_info_sold">
                    <div className="flash-sale_product_info_sold_status">
                      Đang bán chạy
                    </div>
                    <div
                      className="flash-sale_product_info_sold_visual"
