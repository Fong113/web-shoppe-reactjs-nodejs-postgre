...
function ProductCategory() {
  ...
  useLayoutEffect(() => {
    const fetchCategoryInfo = async () => {
      try {
        const productResult =
          await productApi.getProductByCategoryId(categoryId);
      ...
      <div className="category-view_main">
        ...
        <div className="category-view_main_content">
          <div className="category-view_main_content_menu">
            <div className="category-view_main_content_menu_option">
              Sắp xếp theo
            </div>
            ...
            <ul>
              {products.map((post) => {
                return (
                  <Link
                    key={post.id}
                    to={`/product-view/${post.product_name.replace(/ /g, "-")}/${post.id}`}
                  >
                    <li>
                      <Product
                        imageURL={
                          (post.images &&
                            ...
                            post.images[0].image) ||
                          "https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lj0uezovoi6k2b_tn"
                        }
