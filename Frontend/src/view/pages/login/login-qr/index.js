  ...
  return (
    <div>
      <form className="login-qr-form">
        <h3 className="login-qr-header">Đăng nhập mới mã QR</h3>
        <div className="login-qr-image">
          <img src={qrcode} alt="anh" className="login-qr-pic" />
        </div>
        <p className="login-qr-des">Quét mã QR bằng ứng dụng shopee</p>
        <div className="login-qr-link">
          <button className="login-qr-how" onClick={(e) => handleClick(e)}>
      ...
      {show && (
        <div className="login-qr-sidebar">
          <h3 className="login-sidebar-header">Làm thế nào để quét mã?</h3>
