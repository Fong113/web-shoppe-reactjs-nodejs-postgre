          ...
          <div className="product-sale-content">
            ...
            <div className="product-sale-content_rating">
              <svg
                ...
                viewBox="0 0 15 15"
                role="img"
                class="stardust-icon stardust-icon-rating-solid UxAacW"
              >
                <path
            ...
            <div className="product-sale-content_buy">
              <div className="product-sale-content_buy_price">
                <p className="product-sale-content_buy_originPrice">
                  đ {props.price}{" "}
                </p>
                <div className="product-sale-content_buy_line"></div>
                <p>{props.saleprice}</p>
              </div>
              <div className="product-sale-content_buy_buybtn">Mua ngay</div>
            </div>
          </div>
        </div>
      </div>
