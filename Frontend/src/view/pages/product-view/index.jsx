  ...
  useLayoutEffect(() => {
    const fetchProductInfo = async () => {
      try {
        ...
        const color = [
          ...new Set(productResult.data.details.map((item) => item.color)),
        ];
        setColors(color);
        const size = [
          ...new Set(productResult.data.details.map((item) => item.size)),
        ];
        setSizes(size);
    ...
    const buyProduct = () => {
      const selectedItem =
        ...
        product.details.find(
          (item) => item.color === active && item.size === active1,
        );
  ...
  function handleSubmit(e) {
    ...
    const requestPost = async () => {
      try {
        ...
        const product_detail = await productApi.getProductDetail(
          productId,
          details,
        );
          ...
          <div className="pro_detail-container">
            <div className="pro_detail-content">
              <div className="pro_detail-image">
                    ...
                    product.images.slice(0, 5).map((img, index) => {
                      return (
                        <img
                          src={img.image}
                          alt="product"
                          className="pro_detail-img-item"
                          onMouseOver={() => setPicture(img.image)}
                        />
                      );
                    })}
                </div>
                <div className="pro_detail-share">
                  <div className="pro_detail-social">
                    ...
                    <FontAwesomeIcon
                      icon={faInstagram}
                      className="pro-detail-face"
                    />
                    <FontAwesomeIcon
                      icon={faTelegram}
                      className="pro-detail-tele"
                    />
                    <FontAwesomeIcon
                      icon={faPinterest}
                      className="pro-detail-pin"
                    />
                  </div>
                  <div className="pro_detail-line"></div>
                  <div className="pro_detail-like">
                    <FontAwesomeIcon
                      icon={faHeart}
                      className="pro-detail-heart"
              ...
              <div className="pro_detail-body">
                ...
                <div className="pro_detail-rating">
                  <div className="pro_detail-left">
                    <div className="pro_detail-star">
                      ...
                      <Rating
                        name="rating-read"
                        defaultValue={Math.round(product.star)}
                        precision={0.5}
                        size="small"
                        readOnly
                      />
                    </div>
                    <div className="pro_detail-lines"></div>
                ...
                <div className="pro_detail-price">
                  ...
                  <div className="pro_detail-price-about">
                    <div style={{ display: "flex", alignItems: "center" }}>
                      ...
                      <div className="pro_detail-about-box">
                        <span>&#63;</span>
                        <div className="pro_detail-about-mini-box">
                          ...
                          <p>
                            Nhận được sự hỗ trợ rộng rãi từ Dịch vụ chăm sóc
                            khách hàng Shopee và Dịch vụ hỗ trợ Người Bán của
                            Shopee. Sử dụng các công cụ tiếp thị miễn phí để thu
                            hút khách hàng và thúc đẩy doanh số bán hàng Tiếp
                            cận hệ thống vận chuyển chuyên nghiệp một cách nhanh
                            chóng Nhận được thông báo về bài viết/ video hướng
                            dẫn, các khóa học miễn phí tại Học Viện Shopee -
                            Shopee Uni sẽ giúp bạn bán hàng tại Shopee dễ dàng.
                          </p>
                        </div>
                      </div>
                    </div>
                    <p style={{ fontSize: "12px", color: "#767676" }}>
                      Giá tốt nhất với các sản phẩm cùng loại trên Shopee
                    </p>
                  </div>
                </div>
                <table className="pro_detail-table">
                  <tr className="pro_detail-column">
                    <td className="pro_detail-td">Deal Sốc</td>
                    <td>
                      <p className="pro_detail-deal">Mua Kèm Deal Sốc</p>
                    </td>
                  </tr>
                  <tr className="pro_detail-column">
                    <td className="pro_detail-td">Bảo Hiểm</td>
                    <td className="pro_detail-fashion">
                      <p>Bảo hiểm Thời trang</p>{" "}
                      <a href="" className="pro_detail-fashion-link">
                        Tìm hiểu thêm
                      </a>
                    </td>
                  </tr>
                  <tr className="pro_detail-column">
                    <td className="pro_detail-td">Vận Chuyển</td>
                    <td>
                      <div className="pro_detail-delivery">
                        <div className="pro_detail-freeship">
                          <img
                            src={freeship}
                            alt="anh"
                            className="pro_detail-shipimg"
                          />
                          <div>
                            <p className="pro_detail-deli-content">
                              Miễn phí vận chuyển
                              <br />
                              <span
                                style={{
                        ...
                        <div className="pro_detail-priceship">
                          <table className="pro_detail-priceship-table">
                            <tr className="pro_detail-column">
                              <td className="pro_detail-td">Vận Chuyển Tới</td>
                              <td>
                            ...
                            <tr className="pro_detail-column">
                              ...
                              <td className="pro_detail-td">
                                <div className="pro_detail-td-price">
                                  <p className="pro_detail-td-prices">
                                    16.500d{" "}
                                  </p>
                  ...
                  <tr className="pro_detail-column">
                    ...
                    <td>
                      <button
                        className="pro_detail-button"
                        onClick={() => setCount(count - 1)}
                      >
                        -
                      </button>
                      <button className="pro_detail-button-number">
                        {count}
                      </button>
                      <button
                        className="pro_detail-button"
                ...
                <div className="pro_detail-btn">
                  <button
                    className={addProduct ? "disable" : "pro_detail-cart-btn"}
                  ...
                  <button
                    className={addProduct ? "disable" : "pro_detail-buy"}
                    disabled={addProduct}
                  >
                    Mua ngay
                  </button>
            ...
            <div className="pro_detail-description">
              <div className="pro_detail-wrap-left">
                <div className="pro_detail-details">CHI TIẾT SẢN PHẨM</div>
                ...
                <div className="pro_detail-details">MÔ TẢ SẢN PHẨM</div>
                <div className="pro_detail-para">
                  <p>{product.description}</p>
                </div>
              </div>
              <div className="pro_detail-same-products">
                <h4 className="pro_detail-same-header">
