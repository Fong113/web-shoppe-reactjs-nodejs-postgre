      ...
      <div className="review-detail">
        ...
        <div className="review-content">
          ...
          <div className="review-datetime">
            {review.createdAt} <span className="review-line"></span> Phân loại
            hàng: 03
          </div>
        ...
        <div className="review-wrap_box">
          <div className="review-box">
            ...
            <div className="review-list">
              <button
                className="review-btn review-active"
              ...
              <button
                ...
                onClick={() =>
                  setReview(mainReview.filter((r) => r.star === 5))
                }
              >
                5 sao ({mainReview.filter((r) => r.star === 5).length})
              </button>
              <button
                className="review-btn"
                onClick={() =>
                  setReview(mainReview.filter((r) => r.star === 4))
                }
              >
                4 sao ({mainReview.filter((r) => r.star === 4).length})
              </button>
              <button
                className="review-btn"
                onClick={() =>
                  setReview(mainReview.filter((r) => r.star === 3))
                }
              >
                3 sao ({mainReview.filter((r) => r.star === 3).length})
              </button>
              <button
                className="review-btn"
                onClick={() =>
                  setReview(mainReview.filter((r) => r.star === 2))
                }
              >
                2 sao ({mainReview.filter((r) => r.star === 2).length})
              </button>
              <button
                className="review-btn"
                onClick={() =>
                  setReview(mainReview.filter((r) => r.star === 1))
                }
              >
                1 sao ({mainReview.filter((r) => r.star === 1).length})
              </button>
            </div>
          </div>
        </div>
        <div className="review-content">{arrReviews}</div>
      </div>
    </div>
  );
}
