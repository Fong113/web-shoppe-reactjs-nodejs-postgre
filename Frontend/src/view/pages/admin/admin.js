    ...
    <div className="admin-container">
      ...
      <div className="admin-body">
        <div className="admin-navbar">
          <ul className="admin-navbar-item">
            <li
              className={
                active === 1
                  ? "admin-navbar-item-list btn-active"
                  : "admin-navbar-item-list"
              }
            >
        ...
        <div className="admin-content">
          <div
            className={show === 1 ? "admin-main-web active" : "admin-main-web"}
          >
            <Dashboard />
          </div>
          ...
          <div
            className={show === 5 ? "admin-money active" : "hide-page"}
          ></div>
          <div className={show === 6 ? "admin-transfer active" : "hide-page"}>
            <Transport />
          </div>
          <div
            className={show === 7 ? "admin-money active" : "hide-page"}
          ></div>
        </div>
      </div>
    </div>
