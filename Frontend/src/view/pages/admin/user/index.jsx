    ...
    <>
      <div className="user-list-wrapper">
        ...
        <div className="user-list-header">
          ...
          <button className="admin-user-add" onClick={() => setShow(!show)}>
            Thêm người dùng
          </button>
        </div>
        {show ? (
          <div className="admin-user-form-add">
            <form onSubmit={handleAdd}>
              <label for="name" className="admin-user-label">
                Nhập tên
              </label>
              <br />
              <input
              ...
              />
              <br />
              <label for="email" className="admin-user-label">
                Nhập Email
              </label>
              <br />
              <input
              ...
              />
              <br />
              <label for="password" className="admin-user-label">
                Nhập mật khẩu
              </label>
              <br />
              <input
              ...
              item.id === editID ? (
                ...
                <List.Item
                  actions={[
                    ...
                    <Button
                      className="list-loadmore-remove"
        ...
        {pageNumbers.map((pageNumber) => (
          <li key={pageNumber} className="admin-user-pagination-list">
            <button
              ...
              className={
                active === pageNumber
                  ? "admin-user-pagination-btn admin-user-active"
                  : "admin-user-pagination-btn"
              }
            >
              {pageNumber}
            </button>
